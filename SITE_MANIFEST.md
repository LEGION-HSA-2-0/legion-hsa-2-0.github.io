...
### I. Footer (`<footer>`)
* **Funding Card**: Angaben zum Förderprogramm *Heritage Science Austria 2.0* inkl. offiziellem **ÖAW-Logo** (OeAW, Grant `Heritage_2024-12_LEGION`, 2026–2028).
* **Initiative Card**: Eigenständige Kachel zur **Heritage Science Austria** Initiative (interdisziplinäres Netzwerk, Erforschung & Bewahrung materiellen Kulturerbes, E-RIHS-Anbindung, offizielles HSA-Logo und Link zu `heritagescience.at`).
